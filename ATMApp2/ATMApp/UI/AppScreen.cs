...
namespace ATMApp.UI
{
    public class AppScreen
    {
        ...
        internal static void Welcome()
        {
            ...
            Console.WriteLine("3. ATM Services             :");
            Console.WriteLine(":                           :");
            Console.WriteLine("-----------------------------");
        ...
        internal static void AdminWelcome(string AdminId,int AdminPassword)
        {
            Console.WriteLine("Aadmin Authentication Required")
            Console.WriteLine("Please Enter the login id and password")
            string AdminId = Validator.Convert<string>("Login Id");
            int AdminPassword = Convert.ToInt32(Utility.GetSecretInput("Password"));
